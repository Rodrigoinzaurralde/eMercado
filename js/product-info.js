...
function _0x5e1c() {
  const _0x1e4433 = [
    ...
    "70iDiraK",
    "20djIsIx",
    "comentarios-351d5.firebasestorage.app",
    "1311222IdtHpg",
    "4YEbrLg",
    "comentarios-351d5.firebaseapp.com",
    "AIzaSyDztICeC_2I7lEd7PLYtIxsZ0FmYtDIWEI",
    "41628AAVqwV",
  ];
  _0x5e1c = function () {
    return _0x1e4433;
...
(function (_0x3735d4, _0x346855) {
  const _0x52f48c = _0x1e71,
    _0xeb749e = _0x3735d4();
  while (!![]) {
    try {
      const _0x3a6d70 =
        parseInt(_0x52f48c(0xd0)) / 0x1 +
        (parseInt(_0x52f48c(0xd1)) / 0x2) * (-parseInt(_0x52f48c(0xc6)) / 0x3) +
        (-parseInt(_0x52f48c(0xcc)) / 0x4) *
          (-parseInt(_0x52f48c(0xd3)) / 0x5) +
        (-parseInt(_0x52f48c(0xcf)) / 0x6) *
          (-parseInt(_0x52f48c(0xc8)) / 0x7) +
        (-parseInt(_0x52f48c(0xc5)) / 0x8) * (parseInt(_0x52f48c(0xd2)) / 0x9) +
        (parseInt(_0x52f48c(0xc9)) / 0xa) * (-parseInt(_0x52f48c(0xcb)) / 0xb) +
        parseInt(_0x52f48c(0xc7)) / 0xc;
      if (_0x3a6d70 === _0x346855) break;
      else _0xeb749e["push"](_0xeb749e["shift"]());
    } catch (_0xfca29f) {
      _0xeb749e["push"](_0xeb749e["shift"]());
    }
  }
})(_0x5e1c, 0x2ddab);
function _0x1e71(_0x15b5ff, _0x2913e4) {
  const _0x5e1cea = _0x5e1c();
  return (
    (_0x1e71 = function (_0x1e7130, _0x1816fb) {
      _0x1e7130 = _0x1e7130 - 0xc4;
      let _0x5a959d = _0x5e1cea[_0x1e7130];
      return _0x5a959d;
    }),
    _0x1e71(_0x15b5ff, _0x2913e4)
  );
}
const firebaseConfig = {
    apiKey: _0x486134(0xce),
    authDomain: _0x486134(0xcd),
    projectId: "comentarios-351d5",
    storageBucket: _0x486134(0xca),
    messagingSenderId: _0x486134(0xc4),
...
function showProducts(products) {
  ...
  let promedioHTML = promedioValoraciones
    ? ` | <span class='promedio'>Promedio: ${promedioValoraciones} ⭐</span>`
    : "";
...
function mostrarResumenScores(comments) {
  ...
  promedioValoraciones =
    comments.length > 0 ? (totalScore / comments.length).toFixed(2) : null;
...
function mostrarComentarios(comments) {
  ...
  comments.forEach((comment) => {
    let imgSrc =
      comment.user === usuarioActual && imagenPerfilActual
        ? imagenPerfilActual
...
function mostrarCarruselBootstrap(imagenes) {
  const carruselContainer = document.getElementById(
    "imagenes-carrusel-container"
  );
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  stars.forEach((star, idx) => {
    ...
    star.addEventListener("mouseout", () => {
      stars.forEach((s, i) =>
        s.classList.toggle("selected", i < comentarioScore)
      );
    });
  ...
  document
    .getElementById("botonComentarioID")
